...
import '../modules/dictationary/bindings/dictationary_binding.dart';
import '../modules/dictationary/views/dictationary_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      ...
      page: () => const DictationaryView(),
      binding: DictationaryBinding(),
    ),
    GetPage(
