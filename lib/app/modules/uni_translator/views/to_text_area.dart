              ...
              () => SizedBox(
                  ...
                  child: SingleChildScrollView(
                    child: Text(
                      ...
                      style: uniController.translatedText.value != "Translation"
                          ? fontController
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              menuItemsController.shareText(uniController
                          ...
                          IconButton(
                            splashColor: Colors.transparent,
                            onPressed: () {
                              menuItemsController.copyText(uniController
                                  .translatedText.value
                                  .toString());
                            },
                            icon: SvgPicture.asset(
                          ...
                          Obx(
                            () => IconButton(
                              ...
                              icon: SvgPicture.asset(
                                  ...
                                  height: 18,
                                  color: speakerController
                                              .isAvailableFrom.value &&
                                          uniController.translatedText.value !=
                                              "Translation"
                                      ? Colors.black
                                      : Colors.grey),
                          ...
                          IconButton(
                            splashColor: Colors.transparent,
                            onPressed: () {
                              menuItemsController.viewFullScreen(uniController
                                  .translatedText.value
                                  .toString());
                            },
                            icon: SvgPicture.asset(
