...
class FromTextArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    text != ""
        ? speakerController.checkAvailableFrom(languagesController
            .languagesPrefix[languagesController.selectedFromIndex.value])
        : {};
    return Container(
      width: Get.width,
                ...
                () => TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: fontController
                        .inputTextHintStyle(fontController.inputFont.value),
                  ),
                  onChanged: (value) async {
                    inputText = value;
                    speakerController.checkAvailableFrom(
                    ...
                    String translatedText = await uniController.getTranslateUrl(
                        languagesController.languagesPrefix[getIndex],
                        languagesController.languagesPrefix[
                        ...
                        onPressed: () {
                          menuItemsController.colorHeart.value != true
                              ? menuItemsController.addToFav(
                                  ...
                                  "uni")
                              : menuItemsController.removeFav(
                                  "uni", uniController.textContent.toString());
                        },
                        icon: menuItemsController.colorHeart.value
                            ? Icon(
                      ...
                      () => IconButton(
                        ...
                        onPressed: () {
                          if (speakerController.isAvailableFrom.value) {
                            uniController.fromController.text != ""
                                ? speakerController.speakFrom(
                                    uniController.fromController.text)
                                : speakerController.speakFrom(text);
                          } else {
                            Get.snackbar(
                              "Sorry!",
                        ...
                        icon: SvgPicture.asset(
                          ...
                          height: 18,
                          color: speakerController.isAvailableFrom.value
                              ? Colors.black
                              : Colors.grey,
                        ),
                      ),
