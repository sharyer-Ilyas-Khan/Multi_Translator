...
class FavouriteUniCardView extends GetView {
  final data;
  final type;
  const FavouriteUniCardView({Key? key, this.data, this.type})
      : super(key: key);
  @override
                        ...
                        onPressed: () {
                          Get.defaultDialog(
                            ...
                            titlePadding: EdgeInsets.only(
                                right: Get.width * 0.55, top: 20, left: 20),
                            content: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    const Text(
                                      "Are you sure you want to Delete? This action is not revers able.",
                                      style: fromHintStyle,
                                    ),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        TextButton(
                                            onPressed: () {
                                              if (type == 'uni') {
                                                favouriteDatabaseController
                                                    .removeFromUniFavourite(
                                                        data['id']);
                                              }
                                              if (type == 'voice') {
                                                favouriteDatabaseController
                                                    .removeFromVoiceFavourite(
                                                        data['id']);
                                              }
                                              Get.close(1);
                                            },
