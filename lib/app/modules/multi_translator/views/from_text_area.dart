          ...
          children: [
            ...
            Positioned(
                ...
                child: Row(
                  children: [
                        ...
                        onPressed: () {
                          menuItemsController.colorHeart.value != true
                              ...
                              : menuItemsController.removeFav(
                                  "multi", controller.textContent.toString());
                        },
                    ...
                    IconButton(
                        onPressed: () {
                          menuItemsController.viewFullScreen(controller
                              .fromTextController.value.text
                              .toString());
                        },
            ...
            Obx(
              () => Positioned(
                  right: 0,
                  top: 0,
                  child: controller.fromTextController.value.text != ""
                      ? IconButton(
