...
class ImageTextTranslatorView extends GetView<ImageTextTranslatorController> {
  ...
  Widget build(BuildContext context) {
    ImageTextTranslatorController controller =
        Get.put(ImageTextTranslatorController());
    CameraControllers controllers = Get.put(CameraControllers());
    DashboardController dashboardController = Get.put(DashboardController());
    return Stack(
      children: [
        Obx(() => dashboardController.selectedIndex.value == 2
            ? CameraView()
            : Center(
        ...
        Positioned(
          ...
          child: Obx(
            () => controllers.flashOn.value == false
                ? InkWell(
                    onTap: () {
                      controllers.onFlash();
                    },
