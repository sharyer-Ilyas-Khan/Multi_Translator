          ...
          children: [
                  ...
                  IconButton(
                      onPressed: () {
                        ...
                        remoteConfigController.languageIndex == null
                            ? Get.off(() => InitialLanguagesCheckView(),
            ...
            Padding(
              ...
              child: Text(
                ...
                style: inTitleHeading,
              ),
            ),
            Padding(
              padding: EdgeInsets.only(
                  left: Get.width * 0.1, bottom: Get.height * 0.04),
              child: Text(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Removing annoying ads and enjoy ad free experience",
                                style: inAppSubHeading,
                              ),
                              Spacer(),
                            ],
                          ),
                                ...
                                child: Padding(
                                  ...
                                  child: Transform.rotate(
                                      ...
                                      child: SvgPicture.asset(
                                        "Assets/svg/photo_translator.svg",
                                      )),
                                ),
                              ),
                            ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Get translated text of your images directly without even typing.",
                                style: inAppSubHeading,
                              ),
                              Spacer(),
                            ],
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Transform.rotate(
                                      angle: 0.1,
                                      child: SvgPicture.asset(
                                        "Assets/svg/Multi_translator.svg",
                                      )),
                                ),
                              ),
                            ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Multi language Translator (100+Languages supported)",
                                style: inAppHeading,
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              Text(
                                "Translate your text into multiple languages by one click.",
                                style: inAppSubHeading,
                              ),
                              Spacer(),
                            ],
            ...
            Center(
                child: Text(
              "12.66/Life time access of premium feature",
              style: toolTipStyle,
            )),
            SizedBox(
              height: 5,
            ...
            Center(
                child: Text(
              "All language translator Terms and Privacy policy",
              style: policy,
            )),
          ],
        ),
