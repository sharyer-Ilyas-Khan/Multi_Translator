                      ...
                      child: CheckboxListTile(
                          ...
                          onChanged: (value) {
                            ...
                            if (value == true) {
                              ...
                              multiController.listOfPrefix
                                  .add(multiController.languagesPrefix[index]);
                              multiController.addIntoList();
                              multiController.addIntoTranslation();
                            } else {
                              multiController.listOfLang
                                  .remove(languages[index]);
                              multiController.listOfPrefix.remove(
                                  multiController.languagesPrefix[index]);
                            }
