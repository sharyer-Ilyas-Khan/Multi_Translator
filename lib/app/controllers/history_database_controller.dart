...
class HistoryDatabaseController extends GetxController {
  ...
  String createUniHistory="CREATE TABLE uni_history (id INTEGER PRIMARY KEY, 'from' TEXT, 'from_data' TEXT, 'to' TEXT, 'to_data' TEXT)";
  String readUniHistory="SELECT * FROM uni_history";
  String insertUniHistory="INSERT INTO uni_history('from', 'from_data', 'to','to_data') VALUES('eng','abc','ur','alif')";
  String deleteUniHistory="DELETE FROM uni_history WHERE id = 1";
  //voice queries
  //table name = VoiceHistory
  String createVoiceHistory="CREATE TABLE voice_history (id INTEGER PRIMARY KEY, 'from' TEXT, 'from_data' TEXT, 'to' TEXT, 'to_data' TEXT)";
  String readVoiceHistory="SELECT * FROM voice_history";
  String insertVoiceHistory="INSERT INTO voice_history('from', 'from_data', 'to','to_data') VALUES('eng','abc','ur','alif')";
  String deleteVoiceHistory="DELETE FROM voice_history WHERE id = 1";
  //multi queries
  //table name = MultiHistory
  String createMultiHistory="CREATE TABLE multi_history (id INTEGER PRIMARY KEY, 'from' TEXT, 'from_data' TEXT, 'to' LIST, 'to_data' LIST)";
  String readMultiHistory="SELECT * FROM multi_history";
  String insertMultiHistory="INSERT INTO multi_history('from', 'from_data', 'to','to_data') VALUES('eng','abc','[ur,GR]','[alif,'JE']')";
  ...
  void addToUniHistory(from,fromData,to,toData)async{
    await db!.rawInsert("INSERT INTO uni_history('from', 'from_data', 'to','to_data') VALUES('$from','$fromData','$to','$toData')");
  }
  ...
  void addToVoiceHistory(from,fromData,to,toData)async{
    await db!.rawInsert("INSERT INTO voice_history('from', 'from_data', 'to','to_data') VALUES('$from','$fromData','$to','$toData')");
  }
  ...
  void addToMultiHistory(from,fromData,toList,toDataList)async{
    await db!.rawInsert("INSERT INTO multi_history('from', 'from_data', 'to','to_data') VALUES('$from','$fromData','$toList','$toDataList')");
  }
