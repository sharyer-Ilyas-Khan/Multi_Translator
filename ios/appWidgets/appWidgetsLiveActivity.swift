...
struct appWidgetsLiveActivity_Previews: PreviewProvider {
    static let attributes = appWidgetsAttributes(name: "Me")
    static let contentState = appWidgetsAttributes.ContentState(value: 3)
